    ...
    <div className="min-h-screen bg-[--beige] text-gray-900 font-barlowCondensed scroll-smooth">
      ...
      <header className="bg-black text-white shadow-md py-8 px-4 flex flex-col items-center">
        ...
        <nav className="flex flex-wrap justify-center gap-6 text-base sm:gap-8 sm:text-lg text-center">
          <a href="#home" className="text-white hover:text-yellow-400 transition-colors font-medium">
            Home
          </a>
          <a href="#workouts" className="text-white hover:text-yellow-400 transition-colors font-medium">
            Workouts
          </a>
          <a href="#recipes" className="text-white hover:text-yellow-400 transition-colors font-medium">
            Recipes
          </a>
          <a href="#lifestyle" className="text-white hover:text-yellow-400 transition-colors font-medium">
            Lifestyle
          </a>
          <a href="#philosophy" className="text-white hover:text-yellow-400 transition-colors font-medium">
            Philosophy
          </a>
        </nav>
      </header>
      ...
      <main id="home" className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <article className="bg-white rounded-lg shadow-md p-6 sm:p-8 space-y-6">
          ...
          <blockquote className="text-center italic text-lg sm:text-xl text-gray-800 mt-6 mb-6">
